...
class BiometricAuthService {
  ...
  Future<void> saveCredentialsSecurely(String username, String password) async {
    try {
      //print('[ACCESS] 💾 Saving credentials securely...');
      ...
      //print('[ACCESS]   - Username saved successfully');
      
      await _secureStorage.write(key: _biometricPasswordKey, value: password);
      //print('[ACCESS]   - Password saved successfully');
      
      // Verifica immediata che siano stati salvati
      final savedUsername = await _secureStorage.read(key: _biometricUsernameKey);
      final savedPassword = await _secureStorage.read(key: _biometricPasswordKey);
      //print('[ACCESS]   - Verification: Username=${savedUsername != null}, Password=${savedPassword != null}');
      
      //print('[ACCESS] ✅ Credentials saved and verified securely');
    } catch (e) {
      //print('[ACCESS] ❌ Error saving credentials: $e');
  ...
  Future<void> enableBiometric(String username, String password) async {
    try {
      ...
      //print('[ACCESS]   - Enabled flag set to true');
      
      //print('[ACCESS] ✅ Biometric authentication enabled successfully');
    } catch (e) {
      //print('[ACCESS] ❌ Error enabling biometric: $e');
      rethrow;
    }
  }
