...
/// 🏋️ EXERCISE CARD - LAYOUT B WITH HISTORY (Side-by-side + Storico)
/// Layout unificato per tutti gli esercizi con sistema storico integrato
/// Compatibile con superset, circuit e esercizi singoli
class ExerciseCardLayoutBWithHistory extends StatefulWidget {
  ...
  const ExerciseCardLayoutBWithHistory({
    super.key,
  ...
  @override
  _ExerciseCardLayoutBWithHistoryState createState() => _ExerciseCardLayoutBWithHistoryState();
}

class _ExerciseCardLayoutBWithHistoryState extends State<ExerciseCardLayoutBWithHistory> {
  ...
  Widget _buildWeightRepsWithHistory(BuildContext context) {
    ...
    return WeightRepsCombinedWithHistory(
      peso: widget.weight,
      ripetizioni: widget.reps,
      serieNumber: widget.currentSeries,
      lastWorkoutSeries: lastSeries,
      onPesoEdit: widget.onEditParameters,
      onRepsEdit: widget.onEditParameters,
